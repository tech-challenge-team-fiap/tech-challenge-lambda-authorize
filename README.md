...
```bash
lambda-authorized$ sam local invoke HelloWorldFunction --event events/event.json
```
...
```bash
lambda-authorized$ cd HelloWorldFunction
...
```bash
sam delete --stack-name lambda-authorized
```
